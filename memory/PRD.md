...
- ✅ **NEW Jun 2026 — Cinetekk-inspired redesign, LIGHT/RED theme (Phase 1)** — [REVERTED per user — user preferred the dark background. White/red files restored to commit 9f4045f = dark obsidian theme.] Then per user request the dark-theme accent was swapped from champagne-gold (#C9AE72) to **deep cinema red (#E23B3B)** site-wide, then finally to **Monochrome/Platinum (#E5E7EB, Option A)** — the chosen final look. Applied via index.css global remap + Header.jsx + Hero.jsx, plus BlogArticle prose H2/links unified to platinum. Dark obsidian background + editorial typography retained; primary CTAs white. Temporary /public/accent-preview.html was created to compare options and removed after selection.
