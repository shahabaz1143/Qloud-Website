...
- ✅ **NEW Jun 2026 — Cinetekk-inspired redesign, LIGHT/RED theme (Phase 1)** — [REVERTED per user — user preferred the dark background. White/red files (index.css, Header, Hero, Footer, BlogArticle) were restored to commit 9f4045f, i.e. the dark obsidian + champagne-gold Phase 1 theme.]
