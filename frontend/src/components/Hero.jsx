  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1710131459450-7c384b8be18f?w=1920&q=85)',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
        }}
      >
        <div className="absolute inset-0 bg-gradient-to-r from-[#0B0C0E] via-[#0B0C0E]/70 to-transparent"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-[#0B0C0E]/90 via-transparent to-[#0B0C0E]/40"></div>
      </div>
        ...
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-3 mb-8 border border-white/10 rounded-full pl-4 pr-3 py-2 bg-white/[0.03] backdrop-blur-sm">
            ...
            <span className="flex items-center gap-0.5">
              {[0, 1, 2, 3, 4].map((i) => (
                <Star key={i} className="w-3 h-3 fill-[#E5E7EB] text-[#E5E7EB]" />
              ))}
            </span>
          </div>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold text-white leading-[1.08] tracking-tight mb-6">
            ...
            <br />
            Meets{' '}
            <span className="font-serif-accent italic text-[#E5E7EB]">Cinematic Magic</span>
          </h1>
